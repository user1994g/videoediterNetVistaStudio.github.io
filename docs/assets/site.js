(() => {
  ...
  const releaseTag = 'v1.4.0-beta.1';
  const releaseURL = `${repositoryURL}/releases/tag/${releaseTag}`;
  const downloads = {
    mac: `${repositoryURL}/releases/download/${releaseTag}/NetVista-Studio-macOS-1.4-Beta-1.zip`,
    windows: `${repositoryURL}/releases/download/${releaseTag}/NetVista-Studio-Windows-1.4-Beta-1.zip`,
    linux: `${repositoryURL}/releases/download/${releaseTag}/NetVista-Studio-Linux-1.4-Beta-1.zip`
  };
